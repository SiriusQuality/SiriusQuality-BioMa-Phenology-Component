...
namespace SiriusQualityPhenology.Strategies
{
	...
	#region Constructor
			...
			public Phenology()
			{
				...
				VarInfo v1 = new CompositeStrategyVarInfo(_calculategaimean,"TTWindowForPTQ");
				 _parameters0_0.Add(v1);
				VarInfo v2 = new CompositeStrategyVarInfo(_calculatephyllochron,"Ldecr");
				 _parameters0_0.Add(v2);
				VarInfo v3 = new CompositeStrategyVarInfo(_calculatephyllochron,"Lincr");
				 _parameters0_0.Add(v3);
				VarInfo v4 = new CompositeStrategyVarInfo(_calculatephyllochron,"Pdecr");
				 _parameters0_0.Add(v4);
				VarInfo v5 = new CompositeStrategyVarInfo(_calculatephyllochron,"Pincr");
				 _parameters0_0.Add(v5);
				VarInfo v6 = new CompositeStrategyVarInfo(_calculatephyllochronwithptq,"B");
				 _parameters0_0.Add(v6);
				VarInfo v7 = new CompositeStrategyVarInfo(_calculatephyllochronwithptq,"PTQhf");
				...
				VarInfo v15 = new CompositeStrategyVarInfo(_calculatephyllochronwosowingcorrection,"Lincr");
				 _parameters0_0.Add(v15);
				VarInfo v16 = new CompositeStrategyVarInfo(_calculatephyllochronwosowingcorrection,"Pdecr");
				 _parameters0_0.Add(v16);
				VarInfo v17 = new CompositeStrategyVarInfo(_calculatephyllochronwosowingcorrection,"Pincr");
				 _parameters0_0.Add(v17);
				VarInfo v18 = new CompositeStrategyVarInfo(_calculatephyllochronwosowingcorrection,"P");
				 _parameters0_0.Add(v18);
				VarInfo v19 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"SowingDay");
				 _parameters0_0.Add(v19);
				VarInfo v20 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"Latitude");
				 _parameters0_0.Add(v20);
				VarInfo v21 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"SDsa_sh");
				 _parameters0_0.Add(v21);
				VarInfo v22 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"P");
				 _parameters0_0.Add(v22);
				VarInfo v23 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"SDws");
				 _parameters0_0.Add(v23);
				VarInfo v24 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"SDsa_nh");
				 _parameters0_0.Add(v24);
				VarInfo v25 = new CompositeStrategyVarInfo(_calculatephylsowingdatecorrection,"Rp");
				 _parameters0_0.Add(v25);
				VarInfo v26 = new CompositeStrategyVarInfo(_calculateptq,"TTWindowForPTQ");
				 _parameters0_0.Add(v26);
				VarInfo v27 = new CompositeStrategyVarInfo(_calculateptq,"Kl");
				 _parameters0_0.Add(v27);
				VarInfo v28 = new CompositeStrategyVarInfo(_calculateshootnumber,"SowingDensity");
				 _parameters0_0.Add(v28);
				VarInfo v29 = new CompositeStrategyVarInfo(_calculateshootnumber,"TargetFertileShoot");
				 _parameters0_0.Add(v29);
				VarInfo v30 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"AMNFLNO");
				 _parameters0_0.Add(v30);
				VarInfo v31 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"IsVernalizable");
				 _parameters0_0.Add(v31);
				VarInfo v32 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"MinTvern");
				 _parameters0_0.Add(v32);
				VarInfo v33 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"IntTvern");
				 _parameters0_0.Add(v33);
				VarInfo v34 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"VAI");
				 _parameters0_0.Add(v34);
				VarInfo v35 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"VBEE");
				 _parameters0_0.Add(v35);
				VarInfo v36 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"MinDL");
				 _parameters0_0.Add(v36);
				VarInfo v37 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"MaxDL");
				 _parameters0_0.Add(v37);
				VarInfo v38 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"MaxTvern");
				 _parameters0_0.Add(v38);
				VarInfo v39 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"PNini");
				 _parameters0_0.Add(v39);
				VarInfo v40 = new CompositeStrategyVarInfo(_calculatevernalizationprogress,"AMXLFNO");
				 _parameters0_0.Add(v40);
				VarInfo v41 = new CompositeStrategyVarInfo(_registerzadok,"Der");
				 _parameters0_0.Add(v41);
				VarInfo v42 = new CompositeStrategyVarInfo(_registerzadok,"slopeTSFLN");
				 _parameters0_0.Add(v42);
				VarInfo v43 = new CompositeStrategyVarInfo(_registerzadok,"intTSFLN");
				 _parameters0_0.Add(v43);
				VarInfo v44 = new CompositeStrategyVarInfo(_updatephase,"IsVernalizable");
				 _parameters0_0.Add(v44);
				VarInfo v45 = new CompositeStrategyVarInfo(_updatephase,"Dse");
				 _parameters0_0.Add(v45);
				VarInfo v46 = new CompositeStrategyVarInfo(_updatephase,"PFLLAnth");
				 _parameters0_0.Add(v46);
				VarInfo v47 = new CompositeStrategyVarInfo(_updatephase,"Dcd");
				 _parameters0_0.Add(v47);
				VarInfo v48 = new CompositeStrategyVarInfo(_updatephase,"Dgf");
				 _parameters0_0.Add(v48);
				VarInfo v49 = new CompositeStrategyVarInfo(_updatephase,"Degfm");
				 _parameters0_0.Add(v49);
				VarInfo v50 = new CompositeStrategyVarInfo(_updatephase,"MaxDL");
				 _parameters0_0.Add(v50);
				VarInfo v51 = new CompositeStrategyVarInfo(_updatephase,"SLDL");
				 _parameters0_0.Add(v51);
				VarInfo v52 = new CompositeStrategyVarInfo(_updatephase,"IgnoreGrainMaturation");
				 _parameters0_0.Add(v52);
				VarInfo v53 = new CompositeStrategyVarInfo(_updatephase,"PHEADANTH");
				 _parameters0_0.Add(v53);
				VarInfo v54 = new CompositeStrategyVarInfo(_updatephase,"choosePhyllUse");
				 _parameters0_0.Add(v54);
				VarInfo v55 = new CompositeStrategyVarInfo(_updatephase,"P");
				...
				lAssStrat0_0.Add(typeof(SiriusQualityPhenology.Strategies.CalculateGAImean).FullName);
				...
				lAssStrat0_0.Add(typeof(SiriusQualityPhenology.Strategies.CalculatePTQ).FullName);
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						return _calculategaimean.TTWindowForPTQ ;
				}
				set {
						_calculategaimean.TTWindowForPTQ=value;
						_calculateptq.TTWindowForPTQ=value;
				}
			}
			public Double Ldecr
			{ 
			...
			{ 
				get {
						return _calculatephyllochronwithptq.B ;
				}
				set {
						_calculatephyllochronwithptq.B=value;
				}
			}
			public Double PTQhf
			{ 
				get {
						return _calculatephyllochronwithptq.PTQhf ;
				}
				set {
						_calculatephyllochronwithptq.PTQhf=value;
				}
			}
			public Double LARmin
			{ 
				get {
						return _calculatephyllochronwithptq.LARmin ;
				}
				set {
			...
			{ 
				get {
						return _calculatephyllochronwithptq.LNeff ;
				}
				set {
			...
			{ 
				get {
						return _calculateptq.Kl ;
				}
				set {
						_calculateptq.Kl=value;
				}
			}
	...
	#region Parameters initialization method
            ...
            public void SetParametersDefaultValue()
            {
				_modellingOptionsManager.SetParametersDefaultValue();
					...
					_calculategaimean.SetParametersDefaultValue();
					...
					_calculateptq.SetParametersDefaultValue();
	...
	#region Static parameters VarInfo definition
			...
			//Parameters static VarInfo list of the composite class
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculateGAImean.TTWindowForPTQVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculatePhyllochronWithPTQ.BVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculatePhyllochronWithPTQ.PTQhfVarInfo; }
				}
				/// <summary> 
				...
				{
					get { return SiriusQualityPhenology.Strategies.CalculatePTQ.KlVarInfo; }
				}
				/// <summary> 
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					string ret = "";
					 ret += _calculategaimean.TestPostConditions(phenologystate,phenologystate1, "strategy SiriusQualityPhenology.Strategies.CalculateGAImean");
					 ...
					 ret += _calculateptq.TestPostConditions(phenologystate,phenologystate1, "strategy SiriusQualityPhenology.Strategies.CalculatePTQ");
			...
			public string TestPreConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					string ret = "";
					 ret += _calculategaimean.TestPreConditions(phenologystate,phenologystate1, "strategy SiriusQualityPhenology.Strategies.CalculateGAImean");
					 ...
					 ret += _calculateptq.TestPreConditions(phenologystate,phenologystate1, "strategy SiriusQualityPhenology.Strategies.CalculatePTQ");
	...
	#region Model
			...
			SiriusQualityPhenology.Strategies.CalculateGAImean _calculategaimean = new SiriusQualityPhenology.Strategies.CalculateGAImean();
			...
			SiriusQualityPhenology.Strategies.CalculatePTQ _calculateptq = new SiriusQualityPhenology.Strategies.CalculatePTQ();
			...
			private void EstimateOfAssociatedClasses(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1,CRA.AgroManagement.ActEvents actevents){
                ...
                {
                    phenologystate.cumulTTFromZC_65 = phenologystate1.Calendar.cumulTTFrom(GrowthStage.ZC_65_Anthesis, phenologystate.cumulTT);
                }
                if (phenologystate1.Calendar.IsMomentRegistred(GrowthStage.ZC_39_FlagLeafLiguleJustVisible) == 1)
                {
                    phenologystate.cumulTTFromZC_39 = phenologystate1.Calendar.cumulTTFrom(GrowthStage.ZC_39_FlagLeafLiguleJustVisible, phenologystate.cumulTT);
                }
                if (phenologystate1.Calendar.IsMomentRegistred(GrowthStage.ZC_91_EndGrainFilling) == 1)
                {
                    phenologystate.cumulTTFromZC_91 = phenologystate1.Calendar.cumulTTFrom(GrowthStage.ZC_91_EndGrainFilling, phenologystate.cumulTT);
                }
                ...
                {
                    _calculategaimean.Estimate(phenologystate, phenologystate1, actevents);
                    _calculateptq.Estimate(phenologystate, phenologystate1, actevents);
                    _calculatephyllochronwithptq.Estimate(phenologystate, phenologystate1, actevents);

                }
                else if (choosePhyllUse == "Default") _calculatephyllochron.Estimate(phenologystate, phenologystate1, actevents);
                ...
                public void Init(double cumulTTatSowing, DateTime sowingDate, SiriusQualityPhenology.PhenologyState phenologystate1)
                    {
                        //recordSowing
