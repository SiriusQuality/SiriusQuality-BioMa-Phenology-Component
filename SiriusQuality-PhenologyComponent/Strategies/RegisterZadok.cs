...
namespace SiriusQualityPhenology.Strategies
{
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r8 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.hasZadokStageChanged);
					if(r8.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.hasZadokStageChanged.ValueType)){prc.AddCondition(r8);}
					RangeBasedCondition r9 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.currentZadokStage);
					if(r9.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.currentZadokStage.ValueType)){prc.AddCondition(r9);}
					RangeBasedCondition r10 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.Calendar);
					if(r10.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.Calendar.ValueType)){prc.AddCondition(r10);}
			...
			public string TestPreConditions(SiriusQualityPhenology.PhenologyState phenologystate,SiriusQualityPhenology.PhenologyState phenologystate1, string callID)
			{
				try
				{
					...
					SiriusQualityPhenology.PhenologyStateVarInfo.Calendar.CurrentValue=phenologystate.Calendar;
					SiriusQualityPhenology.PhenologyStateVarInfo.IsLatestLeafInternodeLengthPotPositive.CurrentValue=phenologystate.IsLatestLeafInternodeLengthPotPositive;
					...
					RangeBasedCondition r7 = new RangeBasedCondition(SiriusQualityPhenology.PhenologyStateVarInfo.IsLatestLeafInternodeLengthPotPositive);
					if(r7.ApplicableVarInfoValueTypes.Contains( SiriusQualityPhenology.PhenologyStateVarInfo.IsLatestLeafInternodeLengthPotPositive.ValueType)){prc.AddCondition(r7);}
	...
	#region Model
			...
			{				
                ...
                else if (phenologystate.IsLatestLeafInternodeLengthPotPositive == 1 && !(phenologystate1.Calendar[GrowthStage.BeginningStemExtension].HasValue))
                {
                    phenologystate.Calendar.Set(GrowthStage.BeginningStemExtension, phenologystate.currentdate, phenologystate.cumulTT);
                    phenologystate.currentZadokStage = GrowthStage.BeginningStemExtension;
                    phenologystate.hasZadokStageChanged = 1;
