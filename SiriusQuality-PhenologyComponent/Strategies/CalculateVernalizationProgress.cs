...
namespace SiriusQualityPhenology.Strategies
{
	...
	#region Static parameters VarInfo definition
			...
			{                                
				...
				AMNFLNOVarInfo.DefaultValue = 5.5;
				...
				MaxTvernVarInfo.DefaultValue = 23;
				...
				AMXLFNOVarInfo.DefaultValue = 24;
	...
	#region Model
			...
			{				
                ...
                {
                    double TT = phenologystate.DeltaTT;
