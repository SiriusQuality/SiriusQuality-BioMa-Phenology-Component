...
namespace SiriusQualityPhenology
{
    ...
    public class Calendar
    {
        ...
        public class CalendarDailyInfo : IDisposable
        {
            ...
            public CalendarDailyInfo(DateTime date, double cumulTT)
            {
                Date = date;
                CumulTT = cumulTT;
        ...
        public void Set(GrowthStage moment, DateTime theDate, double cumulTT)
        {
        ...
        public double CumulTTOf(GrowthStage moment)
        {
            return (calendarMoments.ContainsKey(moment)) ? calendarMoments[moment].CumulTT : -999;
        }
        ...
        public double cumulTTFrom(GrowthStage from, double CumulTTsinceStart)
        {
            return CumulTTsinceStart - thermalTimeFromBeginning(from);
        }
        ...
        private double thermalTimeFromBeginning(GrowthStage to)
        {
